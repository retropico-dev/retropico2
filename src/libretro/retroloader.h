...
// Function types
typedef RETRO_CALLCONV void (*core_info_fnt)(retro_system_info *info);

typedef RETRO_CALLCONV void (*core_action_fnt)();

typedef RETRO_CALLCONV bool (*core_loadg_fnt)(const retro_game_info *game);

typedef RETRO_CALLCONV void (*core_unloadg_fnt)();
...
typedef RETRO_CALLCONV size_t (*core_serialize_size_fnt)();

typedef RETRO_CALLCONV bool (*core_unserialize_fnt)(const void *data, size_t size);

typedef RETRO_CALLCONV void (*core_get_system_av_info_fnt)(retro_system_av_info *info);
